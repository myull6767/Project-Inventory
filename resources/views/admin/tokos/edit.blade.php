...
@section('title', 'Edit Toko — LJN Inventory')

@section('content')
<div class="max-w-lg">
    <h1 class="font-mono text-lg text-secondary mb-6">Edit Toko</h1>

    <form method="POST" action="{{ route('admin.tokos.update', $toko) }}" class="bg-surface border border-secondary/10 rounded-lg p-6 space-y-5">
        @csrf
        @method('PUT')
